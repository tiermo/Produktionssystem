...
public class ConstructorClient_Stanzen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        data = GetComponent<Drag_Stanzen>().SendInfo();
        ConnectToServer();
        Send(data);
    }
    ...
    private void OnIncomingData(string data)
    {
        if (data.Contains("/"))
        {
            ...
            {
                t.GetComponent<tcpServer_Stanzen>().enabled = true;
                t.GetComponent<StanzenSkript>().enabled = true;
            }
        }
        else
        {
