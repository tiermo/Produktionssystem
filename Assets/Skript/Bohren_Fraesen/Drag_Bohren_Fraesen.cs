...
public class Drag_Bohren_Fraesen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        previousCollidername = GameObject.Find("Bohren/Fraesen").GetComponent<Create_Bohren_Fraesen>().SendColliderName();
    ...
    void OnMouseDrag()
    {
        ...
        {
            serverPort = GetComponent<ConstructorClient_Bohren_Fraesen>().getServerPortNr();
