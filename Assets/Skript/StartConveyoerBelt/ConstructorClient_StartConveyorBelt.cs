...
public class ConstructorClient_StartConveyorBelt : MonoBehaviour{
    ...
    private string data = "%conveyorBelt/0/0";
    ...
    private void OnIncomingData(string data)
    {
        if (data.Contains("/"))
        {
            ...
            {
                sensorStart.GetComponent<tcpSensorStart_StartConveyorBelt>().enabled = true;
                sensorStart.GetComponent<sensorStart_StartConveyorBelt>().enabled = true;

                sensorMid.GetComponent<tcpSensorMid_StartConveyorBelt>().enabled = true;
                sensorMid.GetComponent<sensorMid_StartConveyorBelt>().enabled = true;

                sensorEnd.GetComponent<tcpSensorEnd_StartConveyorBelt>().enabled = true;
                sensorEnd.GetComponent<sensorEnd_StartConveyorBelt>().enabled = true;
                
                GetComponent<tcpServer_StartConveyorBelt>().enabled = true;
