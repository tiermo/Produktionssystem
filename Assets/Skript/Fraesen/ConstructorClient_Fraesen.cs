...
public class ConstructorClient_Fraesen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        data = GetComponent<Drag_Fraesen>().SendInfo();
        ConnectToServer();
        Send(data);
    }
    ...
    private void OnIncomingData(string data)
    {
        if (data.Contains("/"))
        {
            ...
            {
                t.GetComponent<tcpServer_Fraesen>().enabled = true;
                t.GetComponent<FraesenSkript>().enabled = true;
            }
        }
        else
        {
