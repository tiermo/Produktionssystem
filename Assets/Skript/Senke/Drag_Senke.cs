...
public class Drag_Senke : MonoBehaviour {
    ...
    void Start () {
        ...
        {
            previousCollidername = GameObject.Find("Senke").GetComponent<Create_Senke>().SendColliderName();
    ...
    void OnMouseDrag()
    {
        ...
        {
            serverPort = GetComponent<ConstructorClient_Senke>().getServerPortNr();
    ...
    void OnMouseUp()
    {
        if (GetComponent<MeshRenderer>().material.color == Color.green)
        {
            ...
            ConfigManager.changeConfig("PM", previousCollidername, ProductionModule.ModulSenke, true); // Update the current Config
        ...
        else
        {
            ...
            ConfigManager.changeConfig("PM", previousCollidername, ProductionModule.ModulSenke, true);
        }
        GetComponent<MeshRenderer>().material.color = originalColor;
        son.GetComponent<MeshRenderer>().material.color = originalColorSon;
        isDrag = false;
    ...
    {
        if (ConfigManager.getInfoCounter() == 9)
        {
            Infostring = "%" + "Senke 1" + "/" + "7.0" + "/" + "0";
