...
public class tcpServer_Erkennen : MonoBehaviour
{
    ...
    void Start()
    {
        port = transform.parent.gameObject.GetComponent<ConstructorClient_Erkennen>().getModulPortNr();
    ...
    {  //process requests depending on string message received
        ...
        if (string.Compare(data, "material") == 0)
        {
