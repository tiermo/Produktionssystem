...
public class ConstructorClient_Erkennen : MonoBehaviour
{
    ...
    private GameObject t; //son object "sensoren"
    ...
    private void OnIncomingData(string data)
    {
        if (data.Contains("/"))
        {
            ...
            {
                t.GetComponent<tcpServer_Erkennen>().enabled = true;
                t.GetComponent<ErkennenScript>().enabled = true;
            }
        }
        else
        {
