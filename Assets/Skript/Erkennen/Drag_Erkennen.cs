...
public class Drag_Erkennen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        previousCollidername = GameObject.Find("Erkennen").GetComponent<Create_Erkennen>().SendColliderName();
        ...
        Modulname = GameObject.Find("Erkennen").GetComponent<Create_Erkennen>().SendModulName();
