...
public class Drag_Lackieren: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        previousCollidername = GameObject.Find("Lackieren").GetComponent<Create_Lackieren>().SendColliderName();
        ...
        Modulname = GameObject.Find("Lackieren").GetComponent<Create_Lackieren>().SendModulName();
    ...
    void OnMouseDrag()
    {
        ...
        {
            serverPort = GetComponent<ConstructorClient_Erkennen>().getServerPortNr();
