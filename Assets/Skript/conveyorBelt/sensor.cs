...
public class sensor : MonoBehaviour 
{
	...
	void Update () {                     
        ...
        if (monitorFlag && isObjectDetected){   // monitorFlag is true when proximity sensor is enabled
            //Debug.Log("set sensor successfully");
            GetComponent<tcpSensor> ().onObjectDetection ();  // send acknowledgment
            monitorFlag= false;
        }  
	}
	...
	public void setMonitorFlag(){                   // enable proximity sensor
		monitorFlag = true;
	}
