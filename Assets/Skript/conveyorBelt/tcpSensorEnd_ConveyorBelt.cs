...
public class tcpSensorEnd_ConveyorBelt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        port = g.GetComponent<ConstrutorClient_ConveyorBelt>().getSensorPortEndNr();
        if (port == 0)
        {
            port = 6361;
        }
    ...
    {   //process requests depending on string message received
        ...
        {
            GetComponent<sensorEnd_ConveyorBelt>().deactiveMonitorFlag();
        }
    }
