...
public class Drag_MessenModul : MonoBehaviour {
    ...
    void Start()
    {
        ...
        previousCollidername = GameObject.Find("Messen").GetComponent<Create_Messen>().SendColliderName();
        ...
        Modulname = GameObject.Find("Messen").GetComponent<Create_Messen>().SendModulName();
    ...
    void OnMouseDrag()
    {
        ...
        {
            serverPort = GetComponent<ConstructorClient_Messen>().getServerPortNr();
