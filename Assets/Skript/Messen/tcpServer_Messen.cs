...
public class tcpServer_Messen : MonoBehaviour
{
    ...
    void Start()
    {
        port = transform.parent.gameObject.GetComponent<ConstructorClient_Messen>().getModulPortNr();
    ...
    {  //process requests depending on string message received
        ...
        {
            GetComponent<MessenScript>().forwardInformation(data);
