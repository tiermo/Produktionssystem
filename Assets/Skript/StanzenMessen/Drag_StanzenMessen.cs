...
public class Drag_StanzenMessen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        previousCollidername = GameObject.Find("Stanzen/Messen").GetComponent<create_StanzenMessen>().SendColliderName();
        ...
        Modulname = GameObject.Find("Stanzen/Messen").GetComponent<create_StanzenMessen>().SendModulName();
